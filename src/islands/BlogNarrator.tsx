 ...
 *
 * Moved here from components/blog-narrator.tsx with its logic unchanged. Its
 * framework-free half — constants, types and the TTS timing alignment — now
 * lives in src/scripts/narration-core.ts, which the vanilla rewrite will import
 * as-is; what is left in this file is the React DOM and UI layer, and that is
 * all the rewrite has to replace.
 */
