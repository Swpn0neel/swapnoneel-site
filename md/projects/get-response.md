...
- **Tesseract.js** — for extracting context from images and documents
- **PDF-Parse** — for extracting context from images and documents
- **Mermaid.js** — for automatic codebase visualization and diagram generation
- **Boxen** — for a polished, interactive, and user-friendly terminal interface
- **Chalk** — for a polished, interactive, and user-friendly terminal interface
