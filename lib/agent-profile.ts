/**
 * Stable editorial guidance shared by generated agent-facing files.
 * Resume, project, article, education, skills, and link data come from their
 * own canonical sources and must not be duplicated here.
 */
export const agentProfile = {
  ...
  contact:
    "Include the job to be done, relevant project or article, desired outcome, constraints, and timeline.",
  safety:
    "Never send passwords, credentials, private keys, payment details, health records, or confidential customer data through the public contact form.",
  attribution:
