...
export default function NotFound() {
  return (
    ...
    <div className="flex min-h-[55svh] flex-col justify-center py-12 sm:py-16">
      ...
      {/* Held to the game's own 460px measure. The container runs to 768px, and
          centred copy set that wide has no left edge for the eye to return to —
          this used to span the whole of it while the 404 sat in a narrow column
          above, so the top of the page read as two unrelated objects at two
          unrelated widths. */}
      <div className="mx-auto mt-6 max-w-[460px] text-center">
        {/* The page's only heading, and until recently it had none at all: the
            404 above is a <p> on purpose — it is a toy, and it becomes a canvas
            the moment anyone plays with it — so heading navigation found
            nothing here and the page announced no title of its own. */}
